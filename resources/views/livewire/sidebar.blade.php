    ...
    <div class="sidebar-body">
        <div class="menu">
            <ul class="list-none p-0 m-0">
                ...
                <li wire:clck ="changeMenu ('room/index') " @if ($currentMenu == 'room/index') class="active" @endif  class=" hover:bg-orange-300 hover:text-white transition-colors duration-200">
