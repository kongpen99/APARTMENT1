        ...
        <div class="menu">
            <ul class="list-none p-0 m-0">
                <li wire:click ="changeMenu ('dashboard') " @if ($currentMenu == 'dashboard') class="active" @endif  class=" hover:bg-orange-300 hover:text-white transition-colors duration-200" >
                    ...
                    <li wire:click ="changeMenu ('expense/index') " @if ($currentMenu == 'expense/index') class="active" @endif  class=" hover:bg-orange-300 hover:text-white transition-colors duration-200">
